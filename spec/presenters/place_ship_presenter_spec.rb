...
describe PlaceShipPresenter, type: :model do
  ...
  let(:param_info)     { { game_id: game.id, ship_size: 3, start_space: 'A1', end_space: 'A3' } }
  ...
  it 'returns a message' do
    ...
    expect(psp.message).to eq(message)
  end
  ...
  it 'returns a game update hash' do
    ...
    expect(psp.game_update).to eq('player_1_board' => psp.processor.current_board, 'current_turn' => 0)
  end
end
